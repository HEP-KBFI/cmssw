...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        btagDeepCvsL = Var("bDiscriminator('pfDeepCSVJetTags:probc')/(bDiscriminator('pfDeepCSVJetTags:probc') + bDiscriminator('pfDeepCSVJetTags:probudsg'))",float,doc="DeepCSV Charm vs Light Jet (udsg) b-tag discriminator",precision=10),
        btagDeepCvsB = Var("bDiscriminator('pfDeepCSVJetTags:probc')/(bDiscriminator('pfDeepCSVJetTags:probc') + bDiscriminator('pfDeepCSVJetTags:probb') + bDiscriminator('pfDeepCSVJetTags:probbb'))",float,doc="DeepCSV Charm vs b,b+bb b-tag discriminator",precision=10),
